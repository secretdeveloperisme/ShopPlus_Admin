  ...
  <div class="row">
    <div class="col-xl-2 bg-dark sidebar p-2">
      <div class="sidebar-sticky">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item btn-lg bg-primary"><div  class="d-block pl-2 text-white"><i class="fas fa-user-tie"></i><span class="ml-2">Staffs</span></div></li>
        </ul>
      </div>
    </div>
    <div role="main" class="col-xl-10 sidebar-content container-fluid p-2">
      <div class="header d-flex justify-content-between">
        <h1>Staff</h1>
        <div class="btn-group">
          <button id="btnDeleteStaff" class="btn bg-danger text-white"><i class="fas fa-minus"></i> DELETE</button>
        </div>
      </div>
      <table class="table table-striped table-hover bg mt-2" id="staffTable">
